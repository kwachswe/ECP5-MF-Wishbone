...
/* Module Version: 5.7 */
/* C:\lscc\diamond\3.12\ispfpga\bin\nt64\scuba.exe -w -n pll_xclk_base -lang verilog -synth synplify -bus_exp 7 -bb -arch sa5p00m -type pll -fin 125.00 -fclkop 100.00 -fclkop_tol 0.0 -fclkos 3.668 -fclkos_tol 5.0 -phases 0 -fclkos2 66 -fclkos2_tol 5.0 -phases2 0 -phase_cntl STATIC -rst -lock -fb_mode 1 -fdc C:/project/PCIe_ECP5_MF/work/clarity/versa_ecp5/xclk_subsys/pll_xclk_base/pll_xclk_base.fdc  */
/* Sun Feb 27 15:51:06 2022 */


`timescale 1 ns / 1 ps
module pll_xclk_base (CLKI, RST, CLKOP, CLKOS, CLKOS2, LOCK)/* synthesis NGD_DRC_MASK=1 */;
    input wire CLKI;
    input wire RST;
    output wire CLKOP;
    output wire CLKOS;
    ...
    defparam PLLInst_0.CLKOS_CPHASE = 108 ;
    ...
    defparam PLLInst_0.CLKOS_DIV = 109 ;
    ...
    EHXPLLL PLLInst_0 (.CLKI(CLKI), .CLKFB(CLKOP_t), .PHASESEL1(scuba_vlo), 
        ...
        .CLKOS3(), .LOCK(LOCK), .INTLOCK(), .REFCLK(REFCLK), .CLKINTFB())
             ...
             /* synthesis FREQUENCY_PIN_CLKOS="3.669725" */
    ...
    // exemplar attribute PLLInst_0 FREQUENCY_PIN_CLKOS 3.669725
